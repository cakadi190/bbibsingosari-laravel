...
<div class="navbar-nav-wrap">
    ...
    <a class="navbar-brand" href="{{ route('home') }}" aria-label="Front">
        <img class="navbar-brand-logo" src="{{ asset('assets/img/icon-bbib.png') }}" alt="Logo"
            data-hs-theme-appearance="default" style="height: 32px !important; width: auto !important;max-width: unset;min-width: unset;">
        <img class="navbar-brand-logo" src="{{ asset('assets/img/icon-bbib.png') }}" alt="Logo"
            data-hs-theme-appearance="dark" style="height: 32px !important; width: auto !important;max-width: unset;min-width: unset;">
    ...
    <div class="navbar-nav-wrap-content-start">
        ...
        <button type="button" class="js-navbar-vertical-aside-toggle-invoker navbar-aside-toggler">
            <i class="bi-arrow-bar-left navbar-toggler-short-align"
                ...
                data-bs-toggle="tooltip" data-bs-placement="right" title="{{ __('Collapse') }}"></i>
            <i class="bi-arrow-bar-right navbar-toggler-full-align"
                data-bs-template='<div class="tooltip d-none d-md-block" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>'
                data-bs-toggle="tooltip" data-bs-placement="right" title="{{ __('Expand') }}"></i>
        </button>
        ...
        <div class="dropdown ms-2">
            ...
            <div class="d-none d-lg-block">
                <div
                    ...
                    <input type="search" class="js-form-search form-control" placeholder="{!! __('Search any data here&hellip;') !!}"
                        aria-label="{!! __('Search any data here&hellip;') !!}"
                    ...
                    <div class="card-body-height">
                        <div class="d-lg-none">
                            <div class="input-group input-group-merge navbar-input-group mb-5">
                                ...
                                <input type="search" class="form-control" placeholder="{!! __('Search any data here&hellip;') !!}"
                                    aria-label="{!! __('Search any data here&hellip;') !!}">
                                <a class="input-group-append input-group-text" href="javascript:;">
                                    <i class="bi-x-lg"></i>
                                </a>
            ...
            <li class="nav-item">
                ...
                <div class="dropdown">
                    <a class="navbar-dropdown-account-wrapper" href="javascript:;" id="accountNavbarDropdown"
                        ...
                        data-bs-dropdown-animation>
                        <div class="avatar avatar-sm avatar-circle">
                            <img class="avatar-img" src="{{ Gravatar::get(auth()->user()->email) }}"
                                alt="{{ auth()->user()->name }}">
                    ...
                    <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account"
                        ...
                        <div class="dropdown-item-text d-flex">
                            <div class="d-flex gap-3 align-items-center flex-nowrap">
                                <div class="avatar flex-shrink-0 avatar-sm avatar-circle" style="width: 39px">
                                    <img class="avatar-img" src="{{ Gravatar::get(auth()->user()->email) }}"
                                        alt="{{ auth()->user()->name }}">
                                </div>
                                <div class="flex-shrink-1">
                                    <h5 class="mb-0">{{ auth()->user()->name }}</h5>
                                    <p class="card-text text-body text-truncate">{{ Str::limit(auth()->user()->email, 15) }}</p>
                                </div>
                            </div>
                        </div>
